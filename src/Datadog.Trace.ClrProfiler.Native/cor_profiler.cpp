...
HRESULT STDMETHODCALLTYPE CorProfiler::Shutdown()
{
    ...
    Logger::Warn("Exiting. Stats: ", Stats::Instance()->ToString());
...
HRESULT STDMETHODCALLTYPE CorProfiler::ProfilerDetachSucceeded()
{
    ...
    Logger::Warn("Detaching profiler.");
    Logger::Flush();
    is_attached_.store(false);
    return S_OK;
}
                                                     ...
                                                     const std::vector<IntegrationMethod>& filtered_integrations)
{
    ...
    for (const IntegrationMethod& integration : filtered_integrations)
    {
        ...
        while (enumIterator != enumMethods.end())
        {
            ...
            Logger::Info("Enqueue for ReJIT [ModuleId=", module_id, ", MethodDef=", TokenStr(&methodDef),
